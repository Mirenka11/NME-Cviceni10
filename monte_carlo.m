...
vysl=zeros(kroku,1); % vektor pro ukladani vysledku pro vsechny pocty kroku
...
for i=1:kroku
  r=[rand(1,1), rand(1,1)];  % nahodne cislo v intervalu (0,1) 
  value= f(r(1), r(2));  % vypocteme funkci v nahodnem bode
